...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('Campo telefonico continua vazio quando preenchido com valor não-numérico', function () {
        cy.get('#phone')
            .type('abcdefgj')
            .should('have.value', '')
    })
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function() {
        ...
        cy.get('#lastName')
          ...
          .should('have.value', '')
        cy.get('#email')
          .type('diogoexemplo@gmail.com') 
          .should('have.value', 'diogoexemplo@gmail.com')
          .clear()
          .should('have.value', '')  
        cy.get('#phone')
          .type('12345')  
    ...
    it('verifica que a politica de privacidade abre em outra aba sem necessidade de umm clique', function() {
